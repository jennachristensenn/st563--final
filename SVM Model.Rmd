...
```
ALSO LOOK INTO HOW THIS MODEL ACCURACY IS BEING CALCUATED
...
tune_grid <- expand.grid(cost = exp(seq(-5, 3, length.out = 30)))#this generates a sequence of 30 values between -5 and 3
...
print(svm_caret)
```
RERUN BUT REDUCE TUNING GRID SIZE FROM 30 TO 10 AND REPEATS TO 5 INSTEAD OF 10
ALSO SET A LIMIT ON THE NUMBER OF ITERATIONS

also it looks like warning is coming from tuning grid so change that first
